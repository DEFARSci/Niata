...
<div class="w-75 mx-auto pt-3 bg-white  rounded-5">
    <div class="row">
        {{-- <div class="col-md-1"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique quisquam maxime magnam minus atque ab tempore vitae officia aliquid, sequi, natus necessitatibus nulla incidunt aspernatur nam, nobis sint repudiandae. Magni.</div> --}}
        <div class="col-md-7 m-5 ">
            <div class="container">

                <div class="row bg-danger">

                        <div class="col-md-2 col-sm-2 col-xm-2 d-flex justify-content-end">
                            <img src="{{ asset('blog/'.$blog->image) }}" class="rounded-circle mr-3" style="width: 50px; height: 50px;">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xm-5 bg-info">
        ...
        <div class="col-md-2 m-5 border mb-5 rounded-5 " style="background-color: black">
