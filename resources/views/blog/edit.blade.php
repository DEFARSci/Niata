        ...
        <div class="">
            <form action="{{route('blog.update')}}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="form-group  text-black">
                  ...
                  <select class="form-control  text-black" id="tcategorie" name="categorie" placeholder='categorie'>
                ...
                <div class="form-group  text-black">
                    ...
                    <input type="text" class="form-control  text-black" id="titre" name="titre" value="{{$blog->titre}}">
                    @error('titre')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-group  text-black">
                    ...
                    <input type="file" class="form-control  text-black" id="image" name="image" value="{{basename($blog->image)}}" >
                    @error('content')
                    <div class="text-danger">{{ $message }}
                    @enderror
                  </div>
