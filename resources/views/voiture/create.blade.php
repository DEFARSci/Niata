        ...
        <div class="col-md-8">
            <form action="{{route('voiture.store')}}" method="POST"enctype="multipart/form-data" >
               ...
               <div class="row p-3 m-3 text-black ">
                ...
                <div class="form-group col-md-4 text-black">
                ...
                <div class="row p-3 m-3">
                  ...
                  <div class="form-group col-md-4 text-black">
                    ...
                    <input type="text" class="form-control text-black" id="titre" name="etat" value="{{old('etat')}}">
                    @error('etat')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="row p-3 m-3">
                  ...
                  <div class="form-group col-md-4 text-black">
                    ...
                    <input type="text" class="form-control text-black" id="titre" name="caracteristique" value="{{old('caracteristique')}}">
                  ...
                  <div class="form-group col-md-4 text-black">
                    ...
                    <input type="number" class="form-control text-black" id="titre" name="prix" value="{{old('prix')}}">
                    @error('prix')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </div>
